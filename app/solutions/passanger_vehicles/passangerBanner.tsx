      ...
      <div className="relative z-10 flex h-full items-center">
        <div className="container mx-auto px-6 lg:px-16">
          <div className="max-w-2xl">
            ...
            >
              <div
                className="w-16 h-16 rounded-2xl flex items-center justify-center backdrop-blur-xl border border-white/20"
                style={{ backgroundColor: `${currentSlide.color}20` }}
              >
                <IconComponent className="w-8 h-8" style={{ color: currentSlide.color }} />
              </div>
            </motion.div>
